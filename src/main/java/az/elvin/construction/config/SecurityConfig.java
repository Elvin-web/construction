package az.elvin.construction.config;

import az.elvin.construction.handler.SecurityHandler;
import az.elvin.construction.service.UserDetailService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                .authorizeRequests()
                .antMatchers("/", "/products","/products/detail/**","/products/category/**","/products/amount/**",
